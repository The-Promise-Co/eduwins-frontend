...
export default function TeacherProfilePage() {
  ...
  const handleBooking = async () => {
    if (!localStorage.getItem('token')) {
      navigate('/login?redirect=/teachers/' + teacherId)
      return
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden sticky top-4">
              ...
              <div className="aspect-square bg-gradient-to-br from-[#001A72] to-[#FFB81C] flex items-center justify-center">
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = `https://via.placeholder.com/400/001A72/FFFFFF?text=${encodeURIComponent(teacher.full_name || teacher.fullName || 'Teacher')}`;
                  }}
                />
              </div>
        ...
        {/* Booking Card - Fixed at bottom on mobile */}
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 md:sticky md:bottom-auto md:mt-8 md:static md:border-0 md:bg-transparent md:p-0">
