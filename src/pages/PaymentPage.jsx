...
export default function PaymentPage() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const response = await api.post('/paystack/initialize', {
        ...
        email: booking.parentEmail || localStorage.getItem('userEmail'),
        paymentMethod
      })
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-[#001A72]">Loading payment details...</div>
      </div>
    )
  }
  ...
  if (!booking) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-red-600">No booking found</div>
      </div>
    )
  }
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  <label key={method.id} className="flex items-center p-4 border-2 rounded-lg cursor-pointer transition" style={{
                    ...
                    backgroundColor: paymentMethod === method.id ? '#001a72/5' : 'transparent'
                  }}>
                    <input
                      type="radio"
                      name="paymentMethod"
                ...
                <div className="border-b pb-6">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">{booking.sessionDuration || 'To be scheduled'}</span>
                    </div>
                    <div className="flex justify-between">
