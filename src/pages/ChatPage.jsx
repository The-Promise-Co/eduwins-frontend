              ...
              <div key={msg.id} className={`flex ${msg.sender_id === 1 ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-sm px-4 py-2 rounded-lg ${
                  msg.sender_id === 1
                    ...
                    : msg.is_flagged 
                    ? 'bg-secondary/20 text-gray-900 border-2 border-secondary/70'
      ...
      <div className="bg-white border-t border-gray-200 p-4">
        <form onSubmit={sendMessage} className="max-w-4xl mx-auto flex gap-3">
          <input
            ...
            className="flex-1 border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-primary outline-none"
          />
          <button
            type="submit"
