  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-8">
        <h1 className="text-3xl font-bold text-[#001A72] mb-4">
          Ambassador Program
        </h1>
        <p className="text-gray-600 mb-6">
          Earn bonuses by mentoring and referring teachers in a 2-level plan.
        </p>

        {loading && (
          <p className="text-gray-500 animate-pulse">
            Loading ambassador status...
          </p>
        )}
        ...
        {!loading && !data && (
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
            <p className="mb-4 text-blue-800 font-medium">
              You are not an ambassador yet. Ready to join our elite team of
              mentors?
            </p>
            <button
              onClick={apply}
        ...
        {data && (
          <div className="space-y-6">
            ...
            <div className="bg-[#FFB81C]/10 rounded-xl p-6 border-2 border-[#FFB81C]/30 shadow-sm">
              <div className="grid md:grid-cols-2 gap-4 text-[#001A72] mb-6">
                ...
                <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-100">
                  ...
                  <p className="text-xl font-black">
                    {data.indirect_referrals}
                  </p>
                </div>
              </div>

              {/* Earnings */}
              <div className="flex items-center justify-between bg-[#001A72] text-white p-4 rounded-lg">
                <div>
                  <p className="text-xs font-bold uppercase text-blue-200">
                    Total Earned Credits
                  </p>
                  <p className="text-3xl font-black">
                    ₦{data.earned_credits.toLocaleString()}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-green-100 border border-green-200 text-green-700 rounded-full flex items-center justify-center font-bold">
                    1
                  </div>
                  <p className="text-gray-700 text-sm">
                    Refer teachers to Edu-Wins and earn Welfare Fund rewards
                    instantly.
                  </p>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    <span className="font-bold text-[#001A72]">Level 1:</span>{' '}
                    Earn ₦1,000 for each direct teacher referral you bring.
                  </p>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <p className="text-gray-700 text-sm">
                    <span className="font-bold text-[#001A72]">Level 2:</span>{' '}
                    Earn ₦500 for every referral made by your mentees.
                  </p>
                </div>
