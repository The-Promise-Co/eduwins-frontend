...
export default function BookingRequestsPage() {
  ...
  const confirmAndPay = async () => {
    ...
    if (!amount || amount <= 0) {
      toast.error('This booking total is not available yet.');
      return;
    }
  ...
  return (
    <div className="space-y-6 pb-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="flex gap-1 bg-gray-100 p-1 rounded-xl">
              {([
                { key: 'present' as const, label: 'Present', count: presentBookings.length },
      ...
      {requestsQuery.isLoading ? (
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-12 text-center">
          <h2 className="text-lg font-black text-gray-900">No {STATUS_OPTIONS.find((o) => o.value === statusFilter)?.label.toLowerCase() || 'matching'} requests</h2>
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button type="button" onClick={confirmAndPay} className="rounded-xl bg-[#001A72] px-5 py-2.5 text-xs font-black uppercase tracking-wider text-white hover:bg-[#001A72]/90 transition">
              Pay {paymentConfirmBooking ? formatMoney(paymentConfirmBooking.totalAmount ?? paymentConfirmBooking.totalCost) : ''}
            </button>
          </>
        }
      >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-xs">
              ...
              <div className="flex justify-between border-t border-gray-100 pt-2">
                ...
                <span className="font-black text-[#001A72] text-base">{formatMoney(paymentConfirmBooking.totalAmount ?? paymentConfirmBooking.totalCost)}</span>
              </div>
            </div>
